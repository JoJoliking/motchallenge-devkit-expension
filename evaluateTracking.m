...
%
% - benchmark
% The name of the benchmark, e.g. 'MOT15', 'MOT16', 'MOT17', 'DukeMTMCT','MOT20'
%
% Output:
% - allMets
...
for ind = 1:length(allSequences)
    ...
    if ~multicam
        ...
        if strcmp(benchmark, 'MOT16') || strcmp(benchmark, 'MOT17') ||strcmp(benchmark,'MOT20') || strcmp(benchmark, 'CVPR19') % ignore non-pedestrians
            gtdata(gtdata(:,8)~=1,:) = [];
        end
    ...
    if ~multicam
        ...
        if strcmp(benchmark, 'MOT16') || strcmp(benchmark, 'MOT17') ||  strcmp(benchmark,'MOT20')|| strcmp(benchmark, 'CVPR19')
